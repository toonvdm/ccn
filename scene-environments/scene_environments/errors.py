...
def mean_squared_error(rgb_est, rgb_gt):
    """
    Mean Squared Error (MSE)
    :param rgb_est: The observed RGB image at the current position
    :param rgb_gt: The ground truth RGB image
    """
    return np.square(rgb_est - rgb_gt).mean()
